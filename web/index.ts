...
const App = (_: any, state: AppState, setState: SetState) => {
    ...
    const {
        ...
        year = '2020',
        description = 'xxx',
        coverimage=['https://muvibey.ml/English/Extraction/extraction-wide-cover.jpg'],
        // widths=[],
        // heights=[],
        showToast = false,
        messageToast = '',
    ...
    url.searchParams.append('agerating',agerating);
    url.searchParams.append('language',language);
    url.searchParams.append('year',year);
    url.searchParams.append('description',description);
    for(let image of coverimage){
        url.searchParams.append('coverimage',image);
    }
